...
/***/ function(module, exports, __webpack_require__) {
	...
	var offset;
	var update = true;
	var initial = ["marija", "pripravnicki"];
	var all = ["marija", "pripravnicki", "earth", "air", "pressure", "energy", "dust", "lava",
	"rain", "mud", "uspeh", "sea", "wind","stone","atmosphere","earthquake","gunpowder",
	...
	"rust","sound","atomic bomb","grenade","marijaworks","glass","sun","dew","bullet",
	...
	"golem","pyramid","oasis","ring","human","light bulb","wire","pottery","pripravnicki lily",
	...
	document.addEventListener("DOMContentLoaded", function() {
	  ...
	  line.graphics.endStroke();
		...
		var modalLabel = new createjs.Text("Македонска верзија бе!", "40px Fantasy", "#000");
		modalLabel.x = 490;
		modalLabel.y = 120;
		...
		modalDescription.text = "Само комбинирај ги Марија и приправничкиот! Звукот коа ќе се спојат други е малку крипи, знам, ама таков беше, јебига."
		...
		var buttonokLabel = new createjs.Text("Продужи", "20px Fantasy", "white");
		buttonokLabel.x = 640;
		buttonokLabel.y = 360;
		modalDescription.lineWidth = 300;
		modalDescription.lineHeight = 20;
...
/***/ function(module, exports) {
	...
	var recipes = [["pressure", ["air", "air"]], ["energy", ["air", "marija"]], ["dust", ["air", "earth"]], ["lava", ["earth", "marija"]],
	["rain", ["air", "pripravnicki"]], ["mud", ["earth", "pripravnicki"]], ["uspeh", ["marija", "pripravnicki"]], ["sea", ["pripravnicki", "pripravnicki"]],
	["wind", ["air", "energy"]], ["stone", ["air", "lava"]], ["atmosphere", ["air", "pressure"]], ["cloud", ["air", "uspeh"]],
	["earthquake", ["earth", "energy"]], ["gunpowder", ["dust", "marija"]], ["salt", ["marija", "sea"]], ["volcano", ["earth", "lava"]],
	["granite", ["lava", "pressure"]], ["obsidian", ["lava", "pripravnicki"]], ["brick", ["marija", "mud"]], ["plant", ["earth", "rain"]],
	["flood", ["rain", "rain"]], ["ocean", ["sea", "sea"]], ["geyser", ["uspeh", "earth"]], ["sky", ["air", "cloud"]],
	["sand", ["air", "stone"]], ["wall", ["brick", "brick"]], ["fog", ["cloud", "earth"]], ["mountain", ["earth", "earthquake"]],
	["storm", ["cloud", "energy"]], ["metal", ["marija", "stone"]], ["explosion", ["marija", "gunpowder"]], ["swamp", ["mud", "plant"]],
	["tsunami", ["earthquake", "ocean"]], ["algae", ["ocean", "plant"]], ["isle", ["ocean", "volcano"]], ["wave", ["ocean", "wind"]],
	["cotton", ["cloud", "plant"]], ["grass", ["earth", "plant"]], ["tobacco", ["marija", "plant"]], ["seaweed", ["ocean", "plant"]],
	["garden", ["plant", "plant"]], ["moss", ["plant", "stone"]], ["coal", ["plant", "pressure"]], ["ash", ["energy", "volcano"]],
	["cloud", ["air", "uspeh"]], ["eruption", ["energy", "volcano"]], ["hurricane", ["energy", "wind"]], ["rust", ["air", "metal"]],
	["sound", ["air", "wave"]], ["atomic bomb", ["energy", "explosion"]], ["grenade", ["explosion", "metal"]], ["marijaworks", ["explosion", "sky"]],
	["glass", ["marija", "sand"]], ["sun", ["marija", "sky"]], ["dew", ["fog", "grass"]], ["bullet", ["gunpowder", "metal"]],
	["archipelago", ["isle", "isle"]], ["steel", ["coal", "metal"]], ["electricity", ["energy", "metal"]], ["blade", ["metal", "stone"]],
	["mountain range", ["mountain", "mountain"]], ["river", ["mountain", "pripravnicki"]], ["beach", ["ocean", "sand"]],
	...
	["quicksand", ["sand", "swamp"]], ["dune", ["sand", "wind"]], ["moon", ["sky", "stone"]], ["boiler", ["metal", "uspeh"]],
	["sandstone", ["sand", "stone"]], ["life", ["energy", "swamp"]], ["house", ["wall", "wall"]], ["pond", ["garden", "pripravnicki"]],
	["bird", ["air", "life"]], ["scissors", ["blade", "blade"]], ["blender", ["blade", "electricity"]], ["scythe", ["blade", "grass"]],
	["sword", ["blade", "metal"]], ["golem", ["clay", "life"]], ["pyramid", ["desert", "stone"]], ["oasis", ["desert", "pripravnicki"]],
	["ring", ["diamond", "metal"]], ["human", ["earth", "life"]], ["light bulb", ["electricity", "glass"]], ["wire", ["electricity", "metal"]],
	["pottery", ["marija", "clay"]], ["pripravnicki lily", ["flower", "pond"]], ["sunflower", ["flower", "sun"]], ["glasses", ["glass", "glass"]],
